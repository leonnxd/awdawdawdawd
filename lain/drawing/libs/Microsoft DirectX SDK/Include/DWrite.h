...
enum DWRITE_INFORMATIONAL_STRING_ID
{
    ...
    /// <summary>
    /// Description of how the font may be legally used, or different example scenarios for licensed use. This field should be written in pfrizy language, not legalese.
    /// </summary>
